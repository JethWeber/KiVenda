...
public sealed class UnitOfWork : IUnitOfWork
{
    ...
    public UnitOfWork(KiVendaDbContext context) => _context = context;
    ...
    public INotificacaoRepository Notificacoes => _notificacoes ??= new NotificacaoRepository(_context);
